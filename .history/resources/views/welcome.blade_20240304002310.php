...
<body id="body" data-spy="scroll" data-target=".navbar" data-offset="100">
  ...
  <div class="banner" >
    <div class="container">
      ...
      <h6 class="font-weight-normal text-muted pb-3">We offer a large collection of plants and flowers to decorate your house and add life and colors to it. .</h6>
      <div>
      ...
      <br/>
      <div class="banner">
      <img src="images\photo_9_2024-03-03_23-14-07.jpg" alt="" height="800" width="600"  >
      </div>
    </div>
  </div>
  <br/>
  ...
  <section class="digital-marketing-service" id="digital-marketing-section">
    <div class="row align-items-center">
      <div class="col-12 col-lg-7 grid-margin grid-margin-lg-0" data-aos="fade-right">
        <h3 class="m-0">We Offer A Large Collection  <br>Of Flowers And Plants Of All Kinds..</h3>
        <div class="col-lg-7 col-xl-6 p-0">
          <p class="py-4 m-0 text-muted">From Green To Ornamental Plants ,You Can Find All What You Need.</p>
          <p class="font-weight-medium text-muted">Colorful And Rare Kinds Of Flowers Are Here Too!</p>
        </div>    
      </div>
    ...
    <div class="row align-items-center">
      <div class="col-12 col-lg-7 text-center flex-item grid-margin" data-aos="fade-right">
        <img src="images\pots.jpg" alt="" class="img-fluid">
      </div>
      <div class="col-12 col-lg-5 flex-item grid-margin" data-aos="fade-left">
        <h3 class="m-0">We Also Help You To Take  <br>Care Of Your Plants.</h3>
        <div class="col-lg-9 col-xl-8 p-0">
          <p class="py-4 m-0 text-muted">All What You Need To Know About Plants And Flowers And How To Take Good Care Of Them .</p>
          <p class="pb-2 font-weight-medium text-muted">We Also Can Help You To Design Your House With Them.</p>
        </div>
